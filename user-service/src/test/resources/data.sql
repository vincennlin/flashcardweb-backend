...
VALUES ('Test note 1', '2024-06-22 06:55:00', '2024-06-22 06:55:00', (SELECT id FROM users WHERE username = 'test1')),
       ...
       ('Test note 4', '2024-06-22 06:55:00', '2024-06-22 06:55:00', (SELECT id FROM users WHERE username = 'test1')),
       ('Test note 5', '2024-06-22 06:55:00', '2024-06-22 06:55:00', (SELECT id FROM users WHERE username = 'test1'));
