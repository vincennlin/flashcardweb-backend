...
public class AiController {
    ...
    public  ResponseEntity<AbstractFlashcardDto> generateFlashcard(@RequestBody
    ...
    public ResponseEntity<List<AbstractFlashcardDto>> generateFlashcards(@RequestBody
                                                                             @io.swagger.v3.oas.annotations.parameters.RequestBody(
                                                                                     content = @Content(
                                                                                             mediaType = "application/json",
                                                                                             examples = @ExampleObject(value = """
